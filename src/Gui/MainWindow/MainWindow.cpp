...
const char COMMUNITY_FORUM_URL[] = "https://t.me/videogamescoin";
const char REPORT_ISSUE_URL[] = "http://videogamescoin.org/";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("VideoGamesCoin Wallet 2.1").arg(Settings::instance().getVersion()));
